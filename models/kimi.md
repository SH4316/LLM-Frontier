...
| 2025-04-15 | Kimina-Prover Preview / Kimina-Prover-72B | Preview | - | 추론, 컴퓨트 사용, 장문맥 | 자체 배포 비용 확인 | [Kimina-Prover GitHub](https://github.com/MoonshotAI/Kimina-Prover-Preview) | [Kimi 모델 문서](https://platform.kimi.ai/docs/models) | |
...
| 2025-07-11 | Kimi K2 Base / Instruct / `kimi-k2-0711-preview` | Deprecated | - | 코딩, 추론, 장문맥, 에이전트 작업, 컴퓨트 사용 | 구형 가격 확인 | [Kimi K2 GitHub](https://github.com/MoonshotAI/Kimi-K2) | [Kimi 가격](https://platform.kimi.ai/docs/pricing/chat) | K2 계열 2026-05-25 종료 |
...
| 2026-04-20 | Kimi K2.6 / `kimi-k2.6` | Current | value | 코딩, 추론, 멀티모달, 장문맥, 에이전트 작업 | 대표 작업 비용 확인 | [Kimi K2.6](https://www.kimi.ai/blog/kimi-k2-6) | [Kimi K2.6 가격](https://platform.kimi.ai/docs/pricing/chat-k26) | 256K context |
| 2026-06-16 | Kimi K2.7 Code / `kimi-k2.7-code` | Current | frontier | 코딩, 추론, 멀티모달, 장문맥, 에이전트 작업 | 대표 작업 비용 확인 | [Kimi K2.7 Code](https://www.kimi.ai/resources/kimi-k2-7-code) | [Kimi K2.7 문서](https://platform.kimi.ai/docs/guide/kimi-k2-7-code-quickstart) | 256K context |
| 2026-06-16 | Kimi K2.7 Code Highspeed | Current | value | 코딩, 추론, 속도, 멀티모달, 장문맥, 에이전트 작업 | 고속 비용 확인 | [Kimi K2.7 Code](https://www.kimi.ai/resources/kimi-k2-7-code) | [Kimi K2.7 문서](https://www.kimi.ai/resources/kimi-k2-7-code) | |
| 2026-07-16 | Kimi K3 / `kimi-k3` | Current | frontier | 코딩, 추론, 멀티모달, 장문맥, 에이전트 작업, 컴퓨트 사용, 비용 효율 | 대표 작업 비용 확인 | [Kimi K3](https://www.kimi.ai/blog/kimi-k3) | [Kimi K3 가격](https://www.kimi.ai/resources/kimi-k3-pricing) | 1M context |
