...
| 2026-04-23 | GPT-5.5 Pro | Current | other | 코딩, 추론, 멀티모달, 장문맥, 에이전트 작업, Tool call | $30/$180 input/output per 1M tokens | [GPT-5.5](https://openai.com/index/introducing-gpt-5-5/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) | Other 대표: OpenAI 공식 API 문서의 current professional-work Pro variant(1,050,000 context·128,000 max output·function calling/tools). [공식 모델 문서](https://developers.openai.com/api/docs/models/gpt-5.5-pro) |
| 2026-03-17 | GPT-5.4 mini | Current | - | 코딩, 추론, 속도, 멀티모달, 장문맥, 에이전트 작업, 비용 효율, Computer use, Tool call, Vision | 소형·subagent 비용 확인 | [GPT-5.4 mini·nano](https://openai.com/index/introducing-gpt-5-4-mini-and-nano/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) |  |
| 2026-03-17 | GPT-5.4 nano | Current | - | 코딩, 추론, 속도, 멀티모달, 장문맥, 비용 효율, Tool call, Vision | 고처리량·저비용 | [GPT-5.4 mini·nano](https://openai.com/index/introducing-gpt-5-4-mini-and-nano/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) |  |
...
| 2025-08-07 | GPT-5 mini (`gpt-5-mini-2025-08-07`) | Current | - | 코딩, 추론, 속도, 멀티모달, 에이전트 작업, 비용 효율, Tool call, Vision | 저지연·고사용량 | [GPT-5 개발자 소개](https://openai.com/index/introducing-gpt-5-for-developers/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) |  |
| 2025-08-07 | GPT-5 nano (`gpt-5-nano-2025-08-07`) | Current | - | 추론, 속도, 멀티모달, 비용 효율, Tool call, Vision | 최저비용 계열 | [GPT-5 개발자 소개](https://openai.com/index/introducing-gpt-5-for-developers/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) |  |
...
| 2024-07-18 | GPT-4o mini (`gpt-4o-mini-2024-07-18`) | Current | - | 속도, 멀티모달, 장문맥, 에이전트 작업, 비용 효율, Vision | 저비용 모델 | [GPT-4o mini 소개](https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/) | [OpenAI 가격](https://developers.openai.com/api/docs/pricing) | GPT-3.5 대체 후보 |
