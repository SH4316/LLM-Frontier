...
Meta Llama 계열의 주요 공개 가중치 모델 이력입니다. 오픈 웨이트의 다운로드 가능 여부와 상용 호스팅 API의 지원 상태는 별도로 표시합니다.
...
| 2025-04-05 | Llama 4 Scout | Current | value | 멀티모달, 장문맥, 코딩, 추론, 비용 효율 | 단일 GPU 배포 지향 | [Llama 4 소개](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) | [Llama 모델 GitHub](https://github.com/meta-llama/llama-models) | 공개 가중치 |
| 2025-04-05 | Llama 4 Maverick | Current | frontier | 멀티모달, 장문맥, 코딩, 추론 | 자체 배포 비용 확인 | [Llama 4 소개](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) | [Llama 모델 GitHub](https://github.com/meta-llama/llama-models) | 공개 가중치 |
| 2025-04-05 | Llama 4 Behemoth | Preview | - | 멀티모달, 추론, 코딩, 컴퓨트 사용 | 미출시 모델 | [Llama 4 소개](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) | [Llama 모델 GitHub](https://github.com/meta-llama/llama-models) | 발표 당시 학습 중 |
