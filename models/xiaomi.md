...
| 2026-06-29 | MiMo-V2.5-Pro | Current | - | 코딩, 추론, Tool call, 장문맥, 에이전트 작업 | $0.435/$0.87 input/output; cache-hit $0.0036 per 1M | [official open-source release](https://mimo.mi.com/docs/en-US/news/latest/v2.5-open-sourced) | [official pricing](https://mimo.mi.com/) | 1M; MIT |
