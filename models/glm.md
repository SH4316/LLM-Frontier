...
| 2025-04-14 | GLM-Z1-9B-0414 / 32B-0414 / Rumination-32B-0414 | Deprecated | - | 추론, 코딩, 컴퓨트 사용 | 구형 가격 확인 | [GLM-4 GitHub](https://github.com/zai-org/GLM-4) | [BigModel 가격](https://docs.bigmodel.cn/cn/guide/start/pricing) | |
...
| 2025-07-28 | GLM-4.5 / GLM-4.5-X | Current | frontier | 코딩, 추론, 장문맥, 에이전트 작업 | 대표 작업 비용 확인 | [GLM-4.5 문서](https://docs.z.ai/guides/llm/glm-4.5) | [Z.AI 가격](https://docs.z.ai/guides/overview/pricing) | 355B total / 32B active |
| 2025-07-28 | GLM-4.5-Air / GLM-4.5-AirX | Current | value | 코딩, 추론, 속도, 비용 효율, 에이전트 작업 | 경량 에이전트 계열 | [GLM-4.5 문서](https://docs.z.ai/guides/llm/glm-4.5) | [Z.AI 가격](https://docs.z.ai/guides/overview/pricing) | |
...
| 2026-02-12 | GLM-5 | Current | frontier | 코딩, 추론, 장문맥, 에이전트 작업, 컴퓨트 사용 | 대표 작업 비용 확인 | [GLM-5 문서](https://docs.z.ai/guides/llm/glm-5) | [Z.AI 가격](https://docs.z.ai/guides/overview/pricing) | |
...
| 미상 | GLM-5.3 | Current | - | 코딩, 추론, 장문맥, 에이전트 작업 | 공식 가격 확인 | [GLM-5.3 문서](https://docs.bigmodel.cn/cn/guide/models/text/glm-5.3) | [Z.AI 가격](https://docs.z.ai/guides/overview/pricing) | 문서 간 날짜 충돌 |
| 2026-08-26 | GLM-5.3-Flash | Current | value | 코딩, 추론, 속도, 멀티모달, 장문맥, 에이전트 작업, 컴퓨트 사용, 비용 효율 | 대표 작업 비용 확인 | [GLM-5.3-Flash 문서](https://docs.bigmodel.cn/cn/guide/models/vlm/glm-5.3-flash) | [Z.AI 가격](https://docs.z.ai/guides/overview/pricing) | 320B total / 18B active |
