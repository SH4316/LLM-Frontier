...
| 2026-06-16 | GLM-5.2 | Current | other | 추론, 코딩, 장문맥, 에이전트 작업, Tool call | 공식 가격 확인 | [GLM-5.2 문서](https://docs.bigmodel.cn/cn/guide/models/text/glm-5.2) | [BigModel 가격](https://docs.bigmodel.cn/cn/guide/start/pricing) | Other 대표: 공식 문서가 1M context·function calling·MCP·long-horizon engineering을 명시한 current flagship. [공식 모델 문서](https://docs.z.ai/guides/llm/glm-5.2) |
